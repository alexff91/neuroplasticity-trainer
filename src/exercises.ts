...
export const EXERCISES: ExerciseConfig[] = [
  ...
  },
  {
    ...
    scienceRef: 'Soveri, A., et al. (2017). Working memory training revisited: A multi-level meta-analysis of n-back training studies. Psychonomic Bulletin & Review, 24(4), 1077-1096.',
    icon: 'brain',
    minDifficulty: 1,
    maxDifficulty: 10,
  },
  {
    ...
    scienceRef: 'Ball, K., et al. (2002). Effects of cognitive training interventions with older adults: a randomized controlled trial. JAMA, 288(18), 2271-2281.',
    icon: 'zap',
    minDifficulty: 1,
    maxDifficulty: 10,
  },
  ...
  },
  {
    ...
    scienceRef: 'Uttal, D.H., et al. (2013). The malleability of spatial skills: A meta-analysis of training studies. Psychological Bulletin, 139(2), 352-402.',
    icon: 'rotate-3d',
    minDifficulty: 1,
    maxDifficulty: 10,
  },
  {
    ...
    scienceRef: 'Henry, J.D. & Crawford, J.R. (2004). A meta-analytic review of verbal fluency performance following focal cortical lesions. Neuropsychology, 18(2), 284-295.',
    icon: 'type',
    minDifficulty: 1,
    maxDifficulty: 10,
  },
  {
    ...
    scienceRef: 'MacLeod, C.M. (1991). Half a century of research on the Stroop effect: An integrative review. Psychological Bulletin, 109(2), 163-203.',
    icon: 'palette',
    minDifficulty: 1,
    maxDifficulty: 10,
  },
  ...
  },
  {
    ...
    scienceRef: 'Deary, I.J. & Der, G. (2005). Reaction time, age, and cognitive ability: Longitudinal findings from age 16 to 63 years in representative population samples. Aging, Neuropsychology, and Cognition, 12(2), 187-215.',
  ...
  },
  {
    ...
    scienceRef: 'Aziz-Zadeh, L., et al. (2009). "Aha!": The neural correlates of verbal insight solutions. Human Brain Mapping, 30(3), 908-916.',
    icon: 'spell-check',
    minDifficulty: 1,
    maxDifficulty: 10,
  },
